...
export const EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    workingSchedule: SCHEDULE,
    weeklyHours: 40,
    workload: { project: 18, operational: 8, adhoc: 2, other: 2 },
    currentUtilization: 74,
    upcomingTickets: [],
    adhoc: [
      { id: "a1", name: "On-call cloud support", priority: "Medium", deadline: "Ongoing", estimatedHours: 3, status: "Open" },
    ],
    // Leave for 13–17 Sep is not pre-approved — it's the pending handover request
    // (see handover-requests-store) the supervisor reviews during the demo.
    leaveEvents: [],
  },
  {
    id: "yousef-al-ghamdi",
  ...
  },
  {
    ...
    workingSchedule: SCHEDULE,
    weeklyHours: 40,
    workload: { project: 18, operational: 9, adhoc: 2, other: 2 },
    currentUtilization: 71,
    upcomingTickets: [],
    adhoc: [
      { id: "a1", name: "Network on-call rota", priority: "Medium", deadline: "Ongoing", estimatedHours: 3, status: "Open" },
    ],
    leaveEvents: [
  ...
  },
  {
    ...
    knowledgeAreas: ["Cloud Infrastructure", "Server Administration"],
    workingSchedule: SCHEDULE,
    weeklyHours: 40,
    workload: { project: 14, operational: 7, adhoc: 2, other: 2 },
    currentUtilization: 58,
    upcomingTickets: [],
    adhoc: [
      { id: "a1", name: "Server & AD on-call rota", priority: "Medium", deadline: "Ongoing", estimatedHours: 3, status: "Open" },
    ],
    leaveEvents: [],
  },
  {
    ...
    knowledgeAreas: ["Cloud Infrastructure", "Container Platforms"],
    workingSchedule: SCHEDULE,
    weeklyHours: 40,
    workload: { project: 11, operational: 6, adhoc: 2, other: 2 },
    currentUtilization: 47,
    upcomingTickets: [],
    adhoc: [
      { id: "a1", name: "Platform on-call rota", priority: "Medium", deadline: "Ongoing", estimatedHours: 2, status: "Open" },
    ],
    leaveEvents: [
      { id: "l1", type: "Training", start: "06 Sep 2026", end: "07 Sep 2026" },
    ],
  },
  {
    id: "haifa-al-turki",
